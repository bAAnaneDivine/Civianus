...
void affiche_colon(SDL_Rect plateau[N][N],SDL_Renderer *renderer,colon_t * colon){
...
void affiche_ville(SDL_Rect cases[N][N],ville_t *ville,SDL_Renderer *renderer){
      SDL_Texture * texture=NULL;
...
void affiche_batisseur(SDL_Rect plateau[i][j],SDL_Renderer *renderer,batisseur_t* batisseur){
      SDL_Texture * texture;
...
batisseur_t * crea_batisseur(SDL_Rect plateau[N][N],int i,int j){
...
void affiche_guerrier(SDL_Rect plateau[i][j],SDL_Renderer *renderer,guerrier_t* guerrier){
      SDL_Texture * texture;
...
void affiche_arm_spec(SDL_Rect plateau[i][j],SDL_Renderer *renderer,arm_spec_t* arm_spec){
      SDL_Texture * texture;
...
void affiche_arm_long(SDL_Rect plateau[i][j],SDL_Renderer *renderer,arm_long_t* arm_long){
      SDL_Texture * texture;
