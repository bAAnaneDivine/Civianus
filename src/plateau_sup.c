...
void afficher_plateau_sup(SDL_Window *window,SDL_Renderer * renderer,SDL_Rect cases[LONGUEUR_CASE][LARGEUR_CASE],int biome[N][N]){
...
image= IMG_Load("./image/fond_plateau_sup.png");
