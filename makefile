...
bin/prog: obj/main.o obj/admin_SDL.o obj/menu.o obj/plateau.o
	$(CCLNK) $(CFLAGS) obj/main.o obj/admin_SDL.o obj/menu.o obj/plateau.o -o bin/prog $(FLAGS)
...
obj/jeu.o: src/jeu2.c src/headers/admin_SDL.h src/headers/menu.h src/headers/plateau.h src/headers/structure_jeu.h
	$(CCOBJ) $(CFLAGS) src/jeu2.c -o obj/jeu.o $(FLAGS)
